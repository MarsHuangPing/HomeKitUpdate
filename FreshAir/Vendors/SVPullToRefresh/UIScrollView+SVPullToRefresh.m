...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        self.titles = [NSMutableArray arrayWithObjects:NSLocalizedString(@"pulltorefresh_pull",),
                             NSLocalizedString(@"pulltorefresh_release",),
                             NSLocalizedString(@"pulltorefresh_loading",),
                                nil];
