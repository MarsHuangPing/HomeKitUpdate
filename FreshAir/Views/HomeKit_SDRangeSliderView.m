...
@interface HomeKit_SDRangeSliderView()
{
...
@implementation HomeKit_SDRangeSliderView
...
//    if(self.lblLeftValue.center.x <= self.leftCursorButton.center.x)
//    self.lblLeftValue.center = CGPointMake(pan.view.center.x, pan.view.center.y - 20);
