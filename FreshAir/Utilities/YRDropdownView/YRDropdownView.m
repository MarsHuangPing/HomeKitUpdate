...
- (void)sizeToFitFixedWidth:(CGFloat)fixedWidth
{
    ...
    self.lineBreakMode = NSLineBreakByWordWrapping; //UILineBreakModeWordWrap;
                             ...
                             hideAfter:(float)delay
{
    ...
    YRDropdownView *dropdown = [[YRDropdownView alloc] initWithFrame:CGRectMake(0, view.bounds.origin.y, view.bounds.size.width, 54)];
...
- (void)layoutSubviews {    
    ...
    titleLabel.frame = CGRectMake(self.bounds.origin.x + HORIZONTAL_PADDING, 
                                  self.bounds.origin.y + VERTICAL_PADDING  + ([[HomeKit_CommonAPI sharedInstance] isIPhoneXSeries]?20:0),
    ...
    if (self.accessoryImage) {
        ...
        accessoryImageView.frame = CGRectMake(self.bounds.origin.x + HORIZONTAL_PADDING, 
                                              self.bounds.origin.y + VERTICAL_PADDING + 5  + ([[HomeKit_CommonAPI sharedInstance] isIPhoneXSeries]?20:0),
